...
import JobCards from "../Compoents/JobCards";
...
function MainPage() {
  ...
  useEffect(() => {
    const options = {
      ...
      headers: {
        "X-RapidAPI-Key": "c478bebefcmsh0597b4ae86ae54bp187e78jsn6e0ee217b72b",
        "X-RapidAPI-Host": "jsearch.p.rapidapi.com",
      },
    };
    axios
  ...
  return (
    <><div><Navbar/></div>
    <div className="bg-background min-h-screen" style={{marginTop:"50px"}}>
      <div className="font-Poppins max-w-full p-4 text-xl md:p-8 cursor-pointer" style={{display:'flex', justifyContent:'center'}}>
       <h2> <b>Jobs</b> Portal</h2>
      </div>
      {error != null && (
        <div className="bg-primary text-sm rounded text-white font-Poppins max-w-full p-4 mx-4 mb-4 md:p-8 md:mx-8 md:mb-8">
          <div>
            ...
            <i>
              {" "}
              Due to exceeded MONTHLY quota for Requests. You cannot do more requests for the end of the month.{" "}
            </i>
            <b>
...
<div style={{display:'flex', justifyContent:'center'}}>
        ...
        >
          ...
          <input
            ...
            type="submit"
            className="btn btn-primary text-sm rounded-md flex-none m-1 sm:px-6 sm:py-3 sm:text-lg"
            style={{marginLeft:'8px', padding:'10px', width:'100px', }}
          />
        </form>
      ...
      <main className="flex flex-col w-full md:flex-row Portal" >
